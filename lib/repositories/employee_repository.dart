...
class EmployeeRepository {
  ...
  // GET EMPLOYEES (LIST)
  Future<({List<Employee> employees, Pagination pagination})> getEmployees({
    required int page,
    required int limit,
  }) async {
    try {
      ...
      _logger.e('[EmployeeRepository] fetchEmployees error: ${e.message}');
  ...
  Future<Employee> create(Employee employee) async {
    try {
      ...
      _logger.i('[EmployeeRepository] Created employee id=${created.id}');

      return created;
    } on DioException catch (e) {
      _logger.e('[EmployeeRepository] create error: ${e.message}');
      throw Exception(_mapDioError(e));
    }
  }
  ...
  Future<Employee> update(int id, Employee employee) async {
    try {
      ...
      _logger.i('[EmployeeRepository] Updated employee id=$id');

      return updated;
    } on DioException catch (e) {
      _logger.e('[EmployeeRepository] update error: ${e.message}');
      throw Exception(_mapDioError(e));
    }
  }
  ...
  Future<void> delete(int id) async {
    try {
      ...
      _logger.e('[EmployeeRepository] delete error: ${e.message}');
      throw Exception(_mapDioError(e));
    }
  }
