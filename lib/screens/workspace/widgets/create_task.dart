...
class _CreateTaskPageState extends State<CreateTaskPage> {
  ...
  void _handleSubmit() {
    ...
    if (_selectedDepartment == null) {
      SnackBarUtils.showWarning(context, 'Vui lòng chọn phòng ban');
      return;
    }

    if (_selectedType == null) {
      SnackBarUtils.showWarning(context, 'Vui lòng chọn loại công việc');
      return;
    }

    if (_startDate == null) {
      SnackBarUtils.showWarning(context, 'Vui lòng chọn ngày bắt đầu');
      return;
    }

    if (_dueDate == null) {
      SnackBarUtils.showWarning(context, 'Vui lòng chọn ngày hết hạn');
      return;
    }

    if (_dueDate!.isBefore(_startDate!)) {
      SnackBarUtils.showWarning(context, 'Ngày hết hạn phải sau ngày bắt đầu');
      return;
    }
      ...
      builder: (context, state) {
        ...
        if (state is DepartmentsError) {
          return Container(
            ...
            child: const Text('Không thể tải danh sách phòng ban'),
          );
        }
